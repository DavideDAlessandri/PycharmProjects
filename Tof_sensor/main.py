...
class serialPlot:
    ...
    def getSerialData(self, frame, lines, lineValueText, lineLabel, timeText):
        ...
        value, = struct.unpack('h', self.rawData)    # use 'h' for a 2 byte integer  else f
        ...
        # logging.info(value) # to log output values
...
def main():
    ...
    ax.set_xlabel("time")
    ax.set_ylabel("Distance detected")

    lineLabel = 'Tof Sensors Value'
